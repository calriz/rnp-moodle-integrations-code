...
if(is_siteadmin()){
	...
	where c.shortname like '%".$turma."%' and p.course = c.id and p.content like '%https://www.youtube.com/%' and cm.instance = p.id and cm.module =16
				   and  p.content not like '%Transcrição do vídeo%' and p.content not like '%Saiba mais sobre o curso%'   and cm.visible = 1
	union
	...
	where c.shortname like '%".$turma."%' and a.course = c.id and a.intro like '%https://www.youtube.com/%' and cm.instance = a.id and cm.module =1 and  cm.visible = 1 and a.intro not like '%Transcrição do vídeo%' 
	union
	...
	where c.shortname like '%".$turma."%' and l.course = c.id and l.intro like '%https://www.youtube.com/%' and cm.instance = l.id and cm.module =13 and cm.visible = 1 and l.intro not like '%Transcrição do vídeo%' and l.intro not like '%Bem-vindo%' 
	) t
